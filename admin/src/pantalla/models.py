...
#     catalog_id = models.ForeignKey('Catalog', models.DO_NOTHING)
#     created = models.DateTimeField()
#     updated = models.DateTimeField()
...
#     res = models.ForeignKey(CatalogDetail.objects.filter(catalog_id=Catalog.objects.filter(catalog_name=name)), on_delete=models.DO_NOTHING, related_name=name)
#     print(res)
#     return res
...
#     created = models.DateTimeField()
#     updated = models.DateTimeField()
#     key_activity_id = findCatalog("key_activity_2")
...
#     experience_description = models.CharField(max_length=100, blank=True, null=True)
